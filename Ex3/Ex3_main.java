public class Ex3_main {
    public static void main(String[] args) {
        ...
        Disciplina Matemática = new Disciplina();
        Matemática.setNome("Matemática");
        ...
        Disciplina História = new Disciplina();
        História.setNome("História");
        ...
        Disciplina Arquiteturas_de_comp = new Disciplina();
        Arquiteturas_de_comp.setNome("Arquiteturas de Computadores");
